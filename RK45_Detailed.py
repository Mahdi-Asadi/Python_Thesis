...
def dy_dx(x,y):
    def dy_dx1(x,y):
        ...
        dydx_6= -(wa+wp)*y[7] 
        dydx_7= +(wa+wp)*y[6]
        return [dydx_0,dydx_1,dydx_2,dydx_3,dydx_4,dydx_5,dydx_6,dydx_7]
    def dy_dx2(x,y):
        wa=1      # atomic frequency  
        wp=0.6    # field frequency
        g=0.6    # coupling strength 
        ...
        return [dydx_8,dydx_9,dydx_10,dydx_11,dydx_12,dydx_13,dydx_14,dydx_15]
    def dy_dx3(x,y):
        wa=1      # atomic frequency  
        wp=0.6    # field frequency
        g=0.6    # coupling strength 
        ...
        return [dydx_16,dydx_17,dydx_18,dydx_19,dydx_20,dydx_21,dydx_22,dydx_23]
    def dy_dx4(x,y):
        wa=1      # atomic frequency  
        wp=0.6    # field frequency
        g=0.6    # coupling strength 
